    ...
    .run(
      {
        ...
        npmPackages: ['react', 'react-dom', '@cru/mizar'],
        npmGlobalPackages: ['@cru/polaris'],
      },
      {
        duplicates: true,
        showNotFound: true,
        ...
        if (supportsTemplates) {
          ...
          console.log(
            `The ${chalk.cyan(packageInfo.name)} version you're using ${
              packageInfo.name === '@cru/mizar' ? 'is not' : 'may not be'
...
function getInstallPackage(version, originalDirectory) {
  let packageToInstall = '@cru/mizar';
...
function checkAppName(appName) {
  ...
  const dependencies = ['react', 'react-dom', '@cru/mizar'].sort();
